...
> [!TIP]
> To learn more about product licenses, Docker Core seats, and other Docker add-ons see [Docker subscriptions](/manuals/subscription/_index.md),
...
- [Docker subscriptions](/manuals/subscription/_index.md) to learn about different add-ons
