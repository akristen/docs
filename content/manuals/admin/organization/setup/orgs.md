...
1. Once you're done moving all of your users and data, [downgrade](../../../subscription/products/core.md) the secondary account to a free subscription. Note that Docker does not offer refunds for downgrading organizations mid-billing cycle.
