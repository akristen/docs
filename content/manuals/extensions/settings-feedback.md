...
> [!NOTE]
>
> If you are an [organization owner](/manuals/admin/organization/manage/manage-a-team.md#organization-owner), you can turn off extensions for your users. Open the `settings-store.json` file, and set `"extensionsEnabled"` to `false`.
